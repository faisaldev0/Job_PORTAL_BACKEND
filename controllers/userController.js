...
export const login = catchAsyncErrors(async (req, res, next) => {
  ...
  sendToken(user, 200, res, "User logged in successfully.", { sameSite: "None", secure: true });
});
...
export const updatePassword = catchAsyncErrors(async (req, res, next) => {
  ...
  sendToken(user, 200, res, "Password updated successfully.", { sameSite: "None", secure: true });
});
